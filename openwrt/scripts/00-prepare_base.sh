...
git clone https://"$git_name":"$git_password"@$github/Xiaokailnol/package_boot_rkbin package/boot/rkbin -b openwrt-25.12
git clone https://"$git_name":"$git_password"@$github/Xiaokailnol/package_boot_uboot-rockchip package/boot/uboot-rockchip -b openwrt-25.12
git clone https://"$git_name":"$git_password"@$github/Xiaokailnol/arm-trusted-firmware-rockchip package/boot/arm-trusted-firmware-rockchip -b openwrt-25.12
...
curl -s $mirror/openwrt/patch/generic-25.12/0004-build-kernel-add-out-of-tree-kernel-config.patch | patch -p1
curl -s $mirror/openwrt/patch/generic-25.12/0005-include-kernel-add-miss-config-for-linux-6.11.patch | patch -p1
curl -s $mirror/openwrt/patch/generic-25.12/0006-meson-add-platform-variable-to-cross-compilation-fil.patch | patch -p1
curl -s $mirror/openwrt/patch/generic-25.12/0007-tools-squashfs4-enable-lz4-zstd-compression-support.patch | patch -p1
curl -s $mirror/openwrt/patch/generic-25.12/0008-config-include-image-add-support-for-squashfs-zstd-c.patch | patch -p1
curl -s $mirror/openwrt/patch/generic-25.12/0009-include-kernel-Always-collect-module-symvers.patch | patch -p1
curl -s $mirror/openwrt/patch/generic-25.12/0010-include-netfilter-update-kernel-config-options-for-l.patch | patch -p1
...
if [ "$ENABLE_UHTTPD" != "y" ]; then
    ...
    if [ "$version" = "dev" ] || [ "$version" = "v25" ]; then
...
git clone https://"$git_name":"$git_password"@$github/Xiaokailnol/package_kernel_r8168 package/kernel/r8168
git clone https://"$git_name":"$git_password"@$github/Xiaokailnol/package_kernel_r8152 package/kernel/r8152
git clone https://"$git_name":"$git_password"@$github/Xiaokailnol/package_kernel_r8101 package/kernel/r8101
git clone https://"$git_name":"$git_password"@$github/Xiaokailnol/package_kernel_r8125 package/kernel/r8125
git clone https://"$git_name":"$git_password"@$github/Xiaokailnol/package_kernel_r8126 package/kernel/r8126
git clone https://"$git_name":"$git_password"@$github/Xiaokailnol/package_kernel_r8127 package/kernel/r8127
...
git clone https://"$git_name":"$git_password"@$github/Xiaokailnol/package_utils_util-linux -b openwrt-25.12 package/utils/util-linux

# Shortcut Forwarding Engine
git clone https://$github/Xiaokailnol/shortcut-fe package/new/shortcut-fe
...
# FullCone module
git clone https://$github/Xiaokailnol/fullconenat-nft package/new/fullconenat-nft

# IPv6 NAT
git clone https://$github/Xiaokailnol/package_new_nat6 package/new/nat6 -b master

# natflow
git clone https://$github/Xiaokailnol/package_new_natflow package/new/natflow
...
git clone https://$github/Xiaokailnol/luci-app-dockerman -b openwrt-25.12 feeds/luci/applications/luci-app-dockerman
rm -rf feeds/packages/utils/{docker,dockerd,containerd,runc}
git clone https://$github/Xiaokailnol/packages_utils_docker feeds/packages/utils/docker
git clone https://$github/Xiaokailnol/packages_utils_dockerd feeds/packages/utils/dockerd
git clone https://$github/Xiaokailnol/packages_utils_containerd feeds/packages/utils/containerd
git clone https://$github/Xiaokailnol/packages_utils_runc feeds/packages/utils/runc
